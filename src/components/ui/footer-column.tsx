...
const data = {
  ...
  company: {
    name: 'Yallah Baggage',
    description: "Dubai's premier luggage concierge. Travel Light. We'll Handle the Rest.",
    logo: '/Logo.png',
  },
};
...
const aboutLinks = [
  ...
  { text: 'Our Fleet', href: '/#services' },
  { text: 'Areas We Serve', href: '/#services' },
  { text: 'Partnerships', href: '/partnerships' },
];

const serviceLinks = [
  { text: 'Airport Transfer', href: '/' },
  { text: 'Hotel Delivery', href: '/' },
  { text: 'Luggage Storage', href: '/' },
];

const helpfulLinks = [
  { text: 'FAQs', href: '/#faq' },
  { text: 'Hotel Partnerships', href: '/partnerships' },
  { text: 'Live Chat', href: 'mailto:support@yallahbaggage.com' },
];
...
export default function Footer4Col() {
  return (
    <footer id="footer" className="bg-[#0A2E6D] w-full pt-16 pb-8 px-6 lg:px-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {aboutLinks.map(({ text, href }) => (
                  <li key={text}>
                    <Link className="text-sm text-white/50 hover:text-white transition-colors font-medium" href={href}>
                      {text}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {helpfulLinks.map(({ text, href }) => (
                  <li key={text}>
                    <a href={href} className="text-sm text-white/50 hover:text-white transition-colors font-medium">
                      {text}
                    </a>
                  </li>
                ))}
