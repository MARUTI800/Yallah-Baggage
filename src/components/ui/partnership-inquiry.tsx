...
export function PartnershipInquiry() {
  ...
  return (
    <section id="partnership-inquiry" className="w-full bg-white py-24 lg:py-32 border-t border-[#E5E5E5]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        ...
        <div className="lg:w-1/2 flex flex-col items-start">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#0A2E6D] leading-[1.1] tracking-tight mb-6">
            Partner with the UAE&apos;s <span className="text-[#1E5BD7]">#1 Concierge Network</span>
          </h2>
          
          <p className="text-lg text-[#8B7280] mb-10 max-w-lg leading-relaxed">
            Join the UAE&apos;s premier luggage concierge network. Offer your guests seamless luggage management directly from your property while creating new revenue streams.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            {[
              "Boost Guest Reviews",
              "Bell Desk Automation",
              "Revenue Share",
              "VIP Support"
            ].map((benefit, i) => (
              <div key={i} className="flex items-center gap-3 bg-[#F6F2EA]/50 p-4 rounded-xl border border-[#E5E5E5]/50">
                <div className="w-6 h-6 rounded-full bg-[#1E5BD7] flex items-center justify-center text-white text-[10px] font-bold">
                  ✓
                </div>
                <span className="font-semibold text-[#0A2E6D] text-sm">{benefit}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:w-1/2 w-full max-w-lg lg:max-w-none">
          <div className="bg-white border border-[#E5E5E5] p-8 rounded-2xl shadow-[0_4px_40px_rgba(10,46,109,0.06)]">
            <h3 className="text-xl font-bold text-[#0A2E6D] mb-6">Partnership Inquiry</h3>
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-[#0A2E6D] mb-2">Request Received!</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-sm font-semibold text-[#0A2E6D]">Email*</label>
